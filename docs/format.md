...
The `z/x/y/u/w` ASCII frames contain a marker and unpadded base64url of a four-byte CRC32 followed by the codec body. CRC32 catches accidental damage; it isn't authentication.
